    ...
    return (
        ...
        <KeyboardAvoidingView>
            <View style={[styles.bgWhite,styles.h100]}>
                ...
                <TextInput onChangeText={(e)=>setuserName(e)} style={[styles.ms2, styles.my4, styles.p1, styles.border1, { width: '89%', borderRadius: 16, borderColor: "lightgrey",fontSize:17,color:"black" }]} placeholder="Enter your Name"  placeholderTextColor="grey" />
                <TextInput onChangeText={(e)=>setemail(e)} style={[styles.ms2, styles.p1, styles.border1, { width: '89%', borderRadius: 16, borderColor: "lightgrey", marginTop: -24,fontSize:17,color:"black" }]} placeholder="Enter your Email" placeholderTextColor="grey" />
                <TextInput onChangeText={(e)=>setPassword(e)} style={[styles.ms2, styles.p1, styles.border1, { width: '89%', borderRadius: 16, marginTop: 14, borderColor: "lightgrey",fontSize:17,color:"black" }]} placeholder="Enter your password" placeholderTextColor="grey" />
