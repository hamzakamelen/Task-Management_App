        ...
        <>
            ...
            <View style={[styles.bgWhite, styles.h100]}>
                ...
                <TouchableOpacity onPress={() => Submit()} style={[styles.shadowEx, styles.p1, styles.m2, styles.my3, styles.bgPrimary, { shadowColor: '#6f6aee', borderRadius: 15 }]}>
                    <Text style={[styles.fs4, styles.textBold, styles.textCenter, styles.textWhite]}>{isLoading ? <ActivityIndicator /> : <Text>Sign Up</Text>}</Text>
                </TouchableOpacity>
                {Error && <Text style={[styles.textDanger, styles.textBold, styles.textCenter, styles.fs5]}>{Error}! Try Again</Text>}
