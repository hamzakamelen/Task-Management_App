...
function Intro3({navigation}:any){
    return(
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Login')} style={[styles.bgPrimary,styles.flexCenter,styles.w100,{marginLeft:180,height:150,width:110,marginTop:-40,borderTopLeftRadius:250,borderBottomLeftRadius:150}]}>
