        ...
        <>
            <View style={[styles.bgPrimary]}>
                ...
                <View style={[styles.bgWhite, styles.p3, styles.h60, { borderTopRightRadius: 50, borderTopLeftRadius: 50 }]}>
                    ...
                    <Text style={[styles.flexCenter, styles.my1, styles.justifyContentCenter,styles.fs, { color: "lightgrey", marginLeft: 32 }]}>Create a unique emotional story that describe better than words</Text>
